...
const targetStr = `<div key={idx} className="flex items-center justify-between text-xs bg-slate-50 hover:bg-slate-100 p-2 rounded-lg border border-slate-100 font-mono">
...
const replaceStr = `<div key={idx} className="flex items-center justify-between text-sm bg-slate-50 hover:bg-slate-100 p-2 rounded-lg border border-slate-100 font-mono">
                                  <div className="flex items-start gap-2">
